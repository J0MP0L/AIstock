...
if st.button("Run"):
    ...
    กลยุทธ์การซื้อขาย:
            ถ้าผลทำนายคือราคาสูงสุดวันนี้สูงกว่าเมื่อวาน 
                และราคาเปิดจะต้องต่ำกว่าราคาสูงสุดเมื่อวาน
                    ให้ซื้อหุ้นที่ราคาเปิด และตั้งให้ขายหุ้นอัตโนมัติเมื่อราคาพุ่งไปถึงราคาสูงสุดเมื่อวาน
                    แต่หากราคาในวันนี้ไม่สูงถึงราคาสูงสุดเมื่อวานให้ขายหุ้นที่ราคาปิดวันนี้ (หรือตามที่คิดว่าเหมาะสม)
                ถ้าราคาเปิดวันนี้สูงกว่าราคาสูงสุดเมื่อวาน
                    ให้ซื้อหุ้นที่ราคาเปิด และขายที่ราคาปิดวันนี้ (หรือตามที่คิดว่าเหมาะสม)
            ถ้าผลทำนายคือราคาสูงสุดวันนี้ต่ำกว่าเมื่อวาน
                ห้ามทำการซื้อหุ้นในวันนี้
             
            กลยุทธ์นี้ทำกำไร 80% ในช่วง 30 วันที่ผ่านมา
